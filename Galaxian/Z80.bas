...
' -------------------------------------------------------------------------
 ...
 Sub execute()
    ...
    Dim xxx As integer, lTStates As integer, lScanLine As integer, lPrevScanLine As Integer
    
    ' bucle "nunca-sale" (solo pulsando 'ESC')
    While cierto
        'Locate 25,35:Print tstates:screencopy
        If (TStates >= 0) Then
            ' // Trigger an interrupt
 
            TStates = TStates - TstatesPerInterrupt - interrupt()
            'Locate 23,35:Print hola2:hola2+=1
            'Locate 24,35:Print tstates:ScreenCopy
...
' burdo intento de depuracion mio
...
ex118_119:
        If xxx = 118 Then
            ...
            lTStates = 4
              ...
              ' estudiarlas, pero creo que sobran las 4 siguientes
...
execute_end:
        TStates = TStates + lTStates ' descontamos estados "gastados" en cada OP ejecutada
